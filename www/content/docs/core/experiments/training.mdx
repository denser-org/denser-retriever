...
<Callout type="info">
  We run this experiment on a **server**, which requires ES and Milvus installations specified [here](/docs/core/install/install-server).
</Callout>
...
<ImageZoom src="/images/rag-flow-data.png" width={800} height={600} alt="Denser Retriever" className="border border-dashed rounded-md" />
