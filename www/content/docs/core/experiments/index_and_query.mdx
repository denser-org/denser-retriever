...
```bash
poetry run python experiments/index_and_query_local_file.py
```
...
![image](/images/denser-retriever.png)
...
```bash
poetry run python experiments/index_and_query_from_website.py
```
